...
namespace AttendanceRecorder {
    ...
    public partial class hotelDataSet1 : global::System.Data.DataSet {
        ...
        public partial class stockDataTable : global::System.Data.TypedTableBase<stockRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public stockRow AddstockRow(string brandName, int quantity, string type, string volume) {
        ...
        public partial class stockRow : global::System.Data.DataRow {
            ...
            public string brandName {
                get {
                    return ((string)(this[this.tablestock.brandNameColumn]));
                }
                set {
                    this[this.tablestock.brandNameColumn] = value;
                }
            }
            ...
            public string volume {
                get {
                    return ((string)(this[this.tablestock.volumeColumn]));
                }
                set {
...
namespace AttendanceRecorder.hotelDataSet1TableAdapters {
    ...
    public partial class stockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `stock` WHERE ((`stockID` = @p1) AND (`brandName` = @p2) AND (`quanti" +
                "ty` = @p3) AND ((@p4 = 1 AND `type` IS NULL) OR (`type` = @p5)) AND (`volume` = " +
                "@p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `stock` (`brandName`, `quantity`, `type`, `volume`) VALUES (@p1, @p2," +
                " @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `stock` SET `brandName` = @p1, `quantity` = @p2, `type` = @p3, `volume` = " +
                "@p4 WHERE ((`stockID` = @p5) AND (`brandName` = @p6) AND (`quantity` = @p7) AND " +
                "((@p8 = 1 AND `type` IS NULL) OR (`type` = @p9)) AND (`volume` = @p10))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `stockID`, `brandName`, `quantity`, `type`, `volume` FROM `stock`";
        ...
        public virtual int Fill(hotelDataSet1.stockDataTable dataTable) {
        ...
        public virtual hotelDataSet1.stockDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotelDataSet1.stockDataTable dataTable = new hotelDataSet1.stockDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotelDataSet1.stockDataTable dataTable) {
        ...
        public virtual int Delete(int p1, string p2, int p3, string p5, string p6) {
        ...
        public virtual int Update(string p1, int p2, string p3, string p4, int p5, string p6, int p7, string p9, string p10) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
