...
{
    public partial class kasunPaysheetViewer : Form
    {
        String name;
        String empID;
        String designation;
        ...
        public kasunPaysheetViewer()
        {
            InitializeComponent();
        }

        public kasunPaysheetViewer(String name, String empID, String designation, String basicSalary, String leaves, String ot, String epf, String totEarn, String totDeduction, String netPay, String paydate)
        {
            InitializeComponent();
            this.name = name;
            this.empID = empID;
        ...
        private void kasunPaysheetViewer_Load(object sender, EventArgs e)
        {
