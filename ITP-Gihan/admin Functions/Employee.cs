...
namespace AttendanceRecorder
{
    public partial class Employee : Form
    {
        ...
        public Employee(String user,String job,String EmployeeID)
        {
                    ...
                    if (r2.HasRows)
                    {
                        ...
                        while (r2.Read())
                        {
                            ...
                            else if (r2[0].ToString().Equals("etf"))
                            {
                                ...
                                totDeduction = totDeduction + etf + leaves; ;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (ValidationEmployeeSalary())
            {
            kasunPaysheetViewer p = new kasunPaysheetViewer(txtEmpName.Text,txtEmpID.Text,txtDesignation.Text,txtBasicSal.Text,txtLeaves.Text,txtOT.Text,txtEPF.Text,txtTotEarn.Text,txtTotDeduction.Text,txtNetSal.Text,lblPaydate.Text);       
        ...
        {
            EmployeeProfile em = new EmployeeProfile(this.EmployeeID);
            em.Show();
        }

        private void imgNotification_Click(object sender, EventArgs e)
        {
            EmployeeNotifications em = new EmployeeNotifications(this.EmployeeID);
            em.Show();
        }
    }
